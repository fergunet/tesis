...
\ifthenelse{\equal{\value{IncluyeCapitulo}}{3}}{\include{Chapters/02-distributedEAs}}{\myChapter{Evolutionary Algorithms}\label{chap:distributedEAs}}
...
\ifthenelse{\equal{\value{IncluyeCapitulo}}{3}}{\include{Chapters/03-soa}}{\myChapter{Service Oriented Architecture: technologies and restrictions for designing services for EAs}\label{chap:soa}}
\ifthenelse{\equal{\value{IncluyeCapitulo}}{3}}{\include{Chapters/04-soaea}}{\myChapter{A methodology for developing services for EAs}\label{chap:soaea}}
...
\ifthenelse{\equal{\value{IncluyeCapitulo}}{3}}{\include{Chapters/05-osgiliath}}{\myChapter{Implementation of SOA-EA}\label{chap:osgiliath}}
\ifthenelse{\equal{\value{IncluyeCapitulo}}{3}}{\include{Chapters/06-adaptive}}{\myChapter{Parameter adaptation in heterogeneous machines}\label{chap:adaptive}}
\ifthenelse{\equal{\value{IncluyeCapitulo}}{3}}{\include{Chapters/07-art}}{\myChapter{HSV and RGB comparison in Evolutionary Art}\label{chap:art}}
\ifthenelse{\equal{\value{IncluyeCapitulo}}{3}}{\include{Chapters/08-rts}}{\myChapter{Tree depth influence in RTS games}\label{chap:rts}}
