...
\myChapter{Implementation and deployment of services for EAs}\label{chap:osgiliath}
...
In this chapter the last two steps of our methodology (implementation and deployment) are used to implement and deploy the services designed in previous chapter. In this case, the final aim of this whole process is to develop a framework to facilitate to EA practioners the...
...
\section{Implementing the services}
...
\section{Deploying the services}
...
In this section, several experiments to confirm some of the ... are proposed.

\subsection{Converting a basic algorithm into a self-adaptive one} % ¿Una subsección? ¿Seriously? ¿Y con un párrafo? - JJ FERGU: reescrito

Previous sections remarked that using  benefits are also related
...
(Java). % Agh. Además, ¡¡diferentes lenguajes de programación!! - JJ FERGU: afu, fue lo que me dijeron los reviewers del paper de la SoCo!
...
The source code of OSGiLiath is available in \url{http://www.osgiliath.org} under a GNU/GPL license.
