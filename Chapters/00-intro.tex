...
% Propose a methodology that is able to successfully adapt evolutionary algorithms to distributed, dynamic, standards-based environment. FERGU: sí, este sí está mejor como tú dices (es como el paso siguiente al anterior)
