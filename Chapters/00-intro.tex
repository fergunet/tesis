...
\section{Motivation and objectives} %¿Después de explicar los %algoritmos evolutivos? ¿Por qué? - JJ FERGU: canterior                                
...
\newcommand{\objectiveresearch}{Prove that a SOA-based implementation of distributed, dynamic, standards-based evolutionary algorithms is able to solve efficiently a problem of parameter adaptation to hardware} %FERGU: OJO!! Añadir el problema de GP?
