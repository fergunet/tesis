...
performance % utility, más que performance - JJ
 ...
 be used in evolutionary art systems. % ¿Eso es una subclasificación?
                                ...
                                % extensión de EAS- jj FERGU: fuera
...
% automata. % Esto ¿a santo de qué? ¿Qué tiene que ver con las
           % clasificaciones? - JJ FERGU: to fura!
...
In this chapter Processing has been integrated in OSGiLiath
...
% la línea que te he puesto en los comentarios o lo suprimes - JJ FERGU: exactamente era eso lo que había hecho, pero me lo revisaste antes de que lo adaptara más a la tesis. Mira a ver si ahora tiene más sentido con la tesis o lo quito.