...
parents, during a certain number of times. % until algo, ¿no? - JJ
...
whose main goal is to study the differences % with respect to what?
of using
...
classifier. % En una tesis el trabajo futuro no viene a cuento. Tienes
            % que evaluar el trabajo de por sí. - JJ
...
% ejecución y uso de nuevos entornos como el dichoso processing - JJ
...
and \cite{sims1994evolving}. % Si lo que quieres hacer es aportar algo
                             ...
                             % objetivo que es el de la tesis - JJ
...
neural networks or complexity measures.   % ¿Cuál vas a usar? No se
                                ...
                                % interesante o incumba a tu tesis - JJ
...
used. %¿Dónde has justificado el uso de histogramas? Tampoco engañes
 ...
 the following advantages: % No se usa etc en lenguaje formal. Y esto
                           % os lo he dicho en más de mil papers - JJ
...
Processing % usa alguna tipografía para diferenciar processing la librería de processing el verbo - JJ
...
added to the publicly-available source code of OSGiLiath.  % URL - JJ
...
\section{Histograms} % ¿lo ves como antes no hablabas de histogramas? - JJ
...
pixels color intensity values. % ¿ein? ¿Google translator? - JJ
...
parameters of the experiments. % Una tesis debe ser también una metodología. ¿Esta metodología coincide con la del resto de los capítulos? - JJ



\subsection{Individual Representation}

To perform the experiments, the genome of the individual is a list of
circles. % ¿El genoma es una lista para llevar a cabo los experimentos? ¿En serio? - JJ
Each circle has a position, radium and color. This list can
be recombined or mutated (changing the color, position or radium of a
circle of the list). % hala, una subsección con una sola frase. ¿Por qué se
                     ...
                     % general, cualquier otra cosa? - JJ
...
existent image. % Y eso ¿por qué tendría algo que ver con los valores
...
\noindent In this chapter Processing has been integrated in OSGiLiath
to create an Evolutionary Algorithm  to generate images and to extract
image information using HSV and RGB histograms. % .. y esto me ha
...
% la línea que te he puesto en los comentarios o lo suprimes - JJ