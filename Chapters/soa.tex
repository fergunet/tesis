...
\lettrine{D}{espite} the fact the concept service is independent to the technology used, there exist several ways to use and implement them, being the most extended the Web Services, \definicion{ebXML}{Electronic Business XML} and \definicion{Open Service Gateway Inititative}{OSGi}.
...
This advantages are not so
                               ...
                               (Glassfish\footnote{\url{http://glassfish.java.net}} or IBM Websphere \footnote{\url{www.ibm.com/software/websphere/‎}}) or
...
Next chapter will explain the design principles of SOA for developing services for EAs. Then, a specific SOA technology will be used to develop an implementation of a service oriented architecture for EAs.