...
% SOA y el OSGi y OSGILIATH - JJ FERGU: estoy cambiando este capítulo para indicar los problemas en desarrollo, integración, estandarización y dinamismoen EAs. Luego diré "necesitamos una solución para esto!"
...
The heterogeneous computational performance of nodes or network speed can affect the performance of an algorithm. In \cite{Alba2002Heterogeneous},
 ...
 Adapting algorithm parameters to computational nodes % ahora
                                % computational nodes - JJ FERGU: todo va a ser nodes ahora
...
\cite{Salto2012HeterogeneousMigration}. This indicates that heterogeneous parameters
 ...
 devices combination. One of the applications of this thesis will try to
 explain this issue. 
...
\lettrine{O}{ne} of the aims of this thesis is to facilitate the standarization, 
...
Algorithms.  % cada vez que dices There exist, $deity mata a un gatito - JJ FERGU: Okis, los quito todos
Practically every
...
\cite{Cruz2013Erlang}). This is important for example, to integrate 
the elements of the framework in another systems (such as enterprise servers, for example). %FERGU: TODO
