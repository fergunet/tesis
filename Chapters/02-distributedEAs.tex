...
Over the large number of available frameworks (see \cite{SURVEYMOFS} for a complete survey) a representation of them has been selected to explain their lacks, that will be addressed in this thesis.
