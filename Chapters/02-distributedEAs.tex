...
EAs have been proposed. In this section, the differences of the existent classification
with these new trends are explained, and the requirements of each one are presented.

% ¿Y a quién le importa lo que pasó en 2002?
...
These fallacies were not taken into account in the previous classification. However, with the advent of new
...
% resolviendo el problema de conectividad fija (con DHT) o la introducción de nodos destacados (ultrapeers). Esto es un protocolo tipo gossip que podrías mencionar y en todo caso el primer sistema P2P de EAs no fue este, sino DREAM, de donde desciende - JJ
...
\ref{chap:distributed:parameteradapt}
...
development of EAs and existent frameworks are explained and compared 
