\myChapter{Service Oriented Architecture}\label{chap:soa} %cuidado con
...
% En la conclusión del capítulo anterior has dicho que este capítulo iba a resolver diferentes asuntos. ¿Qué asuntos está resolviendo? ¿Qué propones, en general y en particular, para resolverlos? - JJ 
...
This technology % no es una tecnología, es una convención!!! - JJ
...
transmission. % ¿Esto es relevante? - JJ

OSGi allows several implementations for the service distribution.  % so what? - JJ

\section{Methodologies for developing SOA}
Regardless of the chosen SOA framework, the business processes % business? no estamos hablando de algoritmos - JJ
...
In the previous chapter we described several lacks % y dale - JJ
...
\item SOA is the key to develop Open Science
  \cite{Foster2005Science}.% vaya, aquí lo dices, pero antes no - JJ
\end{itemize}
...
order to facilitate the communication and integration among them. % ¿y
 ...
 \citep{SOALIB}. % y esto es interesante porque.. - JJ
