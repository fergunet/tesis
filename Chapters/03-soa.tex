...
\chaptermark{SOA: technologies and restrictions for designing services for EAs}
...
% shortcomings no pueden ser absolutos, tienes que hablar en un contexto determinado. Para algunas cosas trabajar con un script en Perl puede ser perfecto. - JJ FERGU: añadido que hay en algunos contextos, no en general
 ...
 concept \textsc{Service Oriented Architecture} (SOA) \cite{mackenzie2006reference}, with several
...
Finally, SOMA ({\em Service Oriented Modelling and Architecture})
...
\lettrine{T}{o} allow these benefits the services for EAs should match with the next technological
